...
- 2021-07-08T13:53-04, updated 2021-07-09T12:53-04: 'Go' `VisibleHandCard`s render lower than non-'Go' `VisibleHandCard`s in Firefox 89.0.2 but not in Safari 14.1.1 or Chrome 91.0.4472.114 (arm).
...
- UI/UX improvements:
  - Improve user interface via which human players can play against implemented computer discard and play strategies:
    ...
    - add one point for Last Card support; and
